...
Instagram | An Instagram clone where users can create an account, add photos and leave comments, as well as edit their own uploads. This was my first individual Ruby on Rails project. |Ruby on Rails, PostgreSQL, Capybara, Devise, Rspec, Haml, HTML, CSS
Bowling Challenge | My own take on the famous bowling scorecard code kata. The logic proved a substanstial challenge as this was my first javascript project. | Javascript, Jasmine
