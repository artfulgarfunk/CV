...
I'm a **full stack junior developer** and recent graduate of Europe's #1, highly selective software development bootcamp: [Makers Academy](http://makersacademy.com). I'm looking for a challenging role with an exciting team where I can craft **beautiful, functional and expandable** code.
...
## Projects
I have many more projects in a variety of languages and frameworks (Python & Django, JavaScript & React/Node/Express, PHP & Laravel, Ruby & Ruby-on-Rails). Check out my [Github](https://github.com/artfulgarfunk) to see what I'm working on now.

Project | Description | Technologies | Demo
------------ | ------------- | ------------- | ------------- |
[Conveniently Abbreviated](https://github.com/artfulgarfunk/url-shortener-MERN) | In progress. A single page app where a user inputs a link and receives a different URL in return, which when visited will redirect them to the original inputted URL. As the app is deployed on heroku, the URL is particularly long so it may in fact be a URL Lengthener. This was built for fun to get to grips with the MERN stack, especially React. Though the core concept is simple, the program is carefully structured, following good React design patterns (stateful/stateless components etc.) and clear separation of concerns. This was an interesting build because instead of using a web MVC framework with strong conventions and "magic" such as Rails or Django, I had to build each individual part. As a result I understand every line of code within the app (except for node_modules of course!). It has a couple of nice features such as dynamically generated React components, stateless functional components and asynchronous calls to the server. | React, Node, Express, MongoDB, React-Bootstrap, Valid URL (Node Package), HTML, CSS | [Heroku](https://conveniently-abbreviated.herokuapp.com/) |
[ColourMeHappy](https://github.com/artfulgarfunk/Colour-Me-Happy) | A custom image search app. It allows users to select from several colours and display the top image search results for that colour and a random keyword. e.g. 'Blue' & 'Happiness'. It uses Pixabay image search with a back end API call using RectClient which returns the top 5 images. Previously search terms are shown on the results page as buttons and can be searched again by clicking. It was an engaging mini project and I particularly enjoyed working with an external API. The design is deliberately minimal for which I used Bootstrap. |Ruby on Rails, RestClient, Pixabay API, Rspec, Bootstrap 3, HTML, CSS  | [Heroku](https://stark-atoll-86537.herokuapp.com/)
